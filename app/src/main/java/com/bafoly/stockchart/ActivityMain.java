...
public class ActivityMain extends AppCompatActivity {
    ...
    Instrument<String, Double> instrument;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<SingleData<String, Double>> singleData = IndicatorCalculator.getSSMA(instrument.getData(),14);
            ...
            public void onClick(View view) {
                ...
                switch (counter){
                    ...
                    case 1:
                        ...
                        break;
                    default:
                        instrument.setDataDrawStrategy(new DrawOHLC());
                }
    ...
    private List<OHLCVolumeData<String, Double>> getData(){
